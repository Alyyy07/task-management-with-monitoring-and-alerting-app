...
export default function Home() {
  return (
    <div className="flex min-h-screen items-center justify-center bg-background font-sans">
      <main className="flex min-h-screen w-full max-w-3xl flex-col items-center justify-between py-32 px-16 dark:bg-background sm:items-start">
        <Image
          ...
          priority
        />
        <div className="flex flex-col bg-primary-foreground items-center gap-6 text-center sm:items-start sm:text-left">
